...
<div class="constitution">
    <h1 class="noUnderscore">FLEX: Fantasy League of Ex-Athletes LEAGUE CONSTITUTION</h1>
    ...
    <ul>
        ...
        <li>League Scoring Champion: ${dues}</li>
    </ul>
